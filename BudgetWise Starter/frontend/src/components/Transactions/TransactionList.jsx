...
const handleFilterChange = (e) => {
  ...
  return (
    <div className="my-4 p-4 shadow rounded-lg bg-white">
      <h1 className="text-2xl font-bold text-center mb-6">
        Transactions
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <h3 className="text-l font-bold ml-3">Start Date</h3>
        <h3 className="text-l font-bold ml-3">End Date</h3>
        <h3 className="text-l font-bold ml-3">Type</h3>
        <h3 className="text-l font-bold ml-3">Category</h3>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {/* Start Date */}
        <input
